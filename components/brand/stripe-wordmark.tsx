...
/**
 * Official Stripe wordmark (logotype). Sourced from theSVG.org — Stripe's
 * trademark; review their brand guidelines before commercial use.
 * Uses `currentColor` so it inherits text color; defaults to Stripe blurple.
 */
...
/**
 * Stripe wordmark paired with a product sub-label, e.g. "Radar Workshop".
 */
export function StripeLockup({
  label = 'Radar Workshop',
  className,
}: {
  label?: string
  className?: string
